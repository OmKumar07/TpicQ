          ...
          <form onSubmit={generateQuiz}>
            <div className="form-group">
              ...
              >
                ...
                <option value="easy">Easy ({selectedTopics.length * 3} questions)</option>
                <option value="medium">Medium ({selectedTopics.length * 5} questions)</option>
                <option value="hard">Hard ({selectedTopics.length * 7} questions)</option>
              </select>
            </div>
            <button
              type="submit"
            ...
            >
              {loading ? 'Generating Quiz...' : `Generate Quiz (${getQuestionCount()} questions)`}
            </button>
          </form>
        </div>
      </div>
        ...
        <div className="card">
          ...
          <div className="card-body">
            <div className="quiz-info">
              ...
              <span className="badge badge-success">Topics: {quiz.topics.join(", ")}</span>
              {!showAnswers && (
              ...
              <div key={questionIndex} className="question-card">
                <div className="question-header">
                  ...
                  <div>
                    <h5>{question.q}</h5>
                    {question.topic && (
                      <small className="topic-indicator">Topic: {question.topic}</small>
                    )}
                  </div>
                </div>
            ...
            {!showAnswers && Object.keys(selectedAnswers).length === quiz.questions.length && (
